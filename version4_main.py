# ============================================================
# VERSION 4 - MODULE: main.py
# Application entry point - imports and runs everything
# ============================================================
...
from budget_engine import round_to_cents, save_budget, calculate_compound_savings
from finance_models import Budget, BudgetConfig, ExpenseCategory, create_report
...
if __name__ == "__main__":
    ...
    # Savings projections (Topic 13: default parameters)
    ...
    budget_dict = {
        name: exp.amount
        for name, exp in my_budget.expenses.items()  # Topic 10: dict comprehension
    }
